...
{
    public abstract class CSDLWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static CSDLWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(CSDLWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<CSDLDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<CSDLDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<CSDLDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<CSDLDbContext, Task<T>> func)
        {
            T result;
